    ...
    <div className="mt-3 w-full rounded-lg border border-neutral-800 bg-neutral-900/70 p-3">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        <div className="rounded-md border border-neutral-800/80 bg-neutral-900/60 p-2">
          ...
          <Stat label="Velocidad" title="Velocidad — Perfil de tiempo (rápido/normal/lento/auto). Ejemplo: 'rápido' limita presupuesto por jugada; 'lento' permite profundizar más." value={ai?.speed ?? '-'} />
