      ...
      {!collapsed && (
        <div className="grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 12, marginTop: 12 }}>
          ...
          <PlayerCard
            ...
            presetOptions={p1.presetOptions}
            presetSelectedKey={p1.presetSelectedKey}
            onChangePreset={p1.onChangePreset}
          ...
          <PlayerCard
            ...
            presetOptions={p2.presetOptions}
            presetSelectedKey={p2.presetSelectedKey}
            onChangePreset={p2.onChangePreset}
