...
export interface IAPanelProps {
  ...
  onChangeIaConfig: (cfg: Partial<{ quiescence: boolean; qDepthMax: number; qNodeCap: number; futilityMargin: number; bookEnabled: boolean; bookUrl: string; precomputedSupports: boolean; precomputedCenter: boolean; pvsEnabled: boolean; aspirationEnabled: boolean; ttEnabled: boolean; avoidRepeats: boolean; repeatMax: number; avoidPenalty: number }>) => void;
}
