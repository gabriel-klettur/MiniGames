...
1) Diversificación adaptativa en la raíz (epsilon-greedy adaptativa) [Completado]
...
2) Penalización por repetición escalada por conteo [Completado]
...
3) Bonus de novedad (novelty bonus) en la raíz [Completado]
...
4) Multi-PV ligero (Top-K líneas raíz) [Completado]
...
5) Gestión de tiempo sensible al riesgo [Completado]
...
6) Regla de “no-progreso” en simulación [Completado]
...
7) Jitter sembrado en ordenación raíz bajo repetición [Completado]
...
8) LMR (Late Move Reductions) sensible a repetición [Completado]
...
9) Persistencia de anti-bucles entre partidas [Completado]
...
10) Ajustes de evaluación para marcar “ciclos = malos” [Completado]
