...
export default function UIUX() {
  // Local tab state
  const [tab, setTab] = useState<'calib' | 'tablero' | 'fichas' | 'animaciones'>('calib');
  ...
  return (
    <div className="mt-3 w-full rounded-lg border border-neutral-800 bg-neutral-900/70 p-3 overflow-hidden">
      ...
      <div className="mb-3 flex flex-wrap items-center gap-2">
        ...
        <Button size="sm" variant={tab === 'tablero' ? 'primary' : 'neutral'} onClick={() => setTab('tablero')}>Tablero</Button>
